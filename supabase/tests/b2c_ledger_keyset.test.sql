...
insert into public.b2c_payments (
  ...
  ('91000000-0000-4000-8000-000000000001', 'stripe', 'keyset-moved-in', 'moved.in@playbook.test', 'Moved In', 'succeeded', 11, 'USD', 1, 11, 11, '2026-07-30 10:00:00+00', '2026-07-30', repeat('1', 64)),
  ('91000000-0000-4000-8000-000000000002', 'stripe', 'keyset-moved-out', 'moved.out@playbook.test', 'Moved Out', 'succeeded', 12, 'USD', 1, 12, 12, '2026-08-15 10:00:00+00', '2026-08-15', repeat('2', 64)),
  ('91000000-0000-4000-8000-000000000003', 'stripe', 'keyset-tie-a', 'tie.a@playbook.test', 'Tie A', 'succeeded', 13, 'USD', 1, 13, 13, '2026-08-20 10:00:00+00', '2026-08-20', repeat('3', 64)),
  ('91000000-0000-4000-8000-000000000004', 'stripe', 'keyset-tie-b', 'tie.b@playbook.test', 'Tie B', 'succeeded', 13, 'USD', 1, 13, 13, '2026-08-20 11:00:00+00', '2026-08-20', repeat('4', 64));
...
insert into public.b2c_payments (
  ...
  ('92000000-0000-4000-8000-000000000001', 'stripe', 'summary-clean', 'summary.clean@playbook.test', 'Summary Clean', 'succeeded', 100, 'USD', 1, 100, 100, '2026-09-01 10:00:00+00', '2026-09-01', repeat('5', 64)),
  ('92000000-0000-4000-8000-000000000002', 'stripe', 'summary-override', 'summary.override@playbook.test', 'Summary Override', 'succeeded', 50, 'USD', 1, 50, 50, '2026-09-02 10:00:00+00', '2026-09-02', repeat('6', 64)),
  ('92000000-0000-4000-8000-000000000003', 'stripe', 'summary-missing-email', null, 'Summary Missing', 'succeeded', 30, 'USD', 1, 30, 30, '2026-09-03 10:00:00+00', '2026-09-03', repeat('7', 64)),
  ('92000000-0000-4000-8000-000000000004', 'tap', 'summary-failed', 'summary.failed@playbook.test', 'Summary Failed', 'failed', 40, 'USD', 1, 40, 40, '2026-09-04 10:00:00+00', '2026-09-04', repeat('8', 64)),
  ('92000000-0000-4000-8000-000000000005', 'tap', 'summary-foreign', 'summary.fx@playbook.test', 'Summary FX', 'succeeded', 10, 'BHD', null, null, null, '2026-09-05 10:00:00+00', '2026-09-05', repeat('9', 64)),
  ('92000000-0000-4000-8000-000000000006', 'stripe', 'summary-exception', null, 'Summary Exception', 'succeeded', 20, 'USD', 1, 20, 20, '2026-09-06 10:00:00+00', '2026-09-06', repeat('a', 64));
