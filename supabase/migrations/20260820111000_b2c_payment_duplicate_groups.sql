...
-- Product mapping writers explicitly lock affected source payments before
-- updating duplicate-trigger columns. Preserve their latest behavior while
-- joining the workflow mutex before the first database read or row lock.
