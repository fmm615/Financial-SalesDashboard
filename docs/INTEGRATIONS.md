...
- Balance Transaction gross, fee, fee-tax, net, settlement currency, and Stripe exchange-rate values are retained as Admin-only reconciliation evidence. Direct Invoice tax may also be retained. These fields never replace Charge gross sales, establish a Finance-approved conversion, subtract VAT, or alter B2C totals.
