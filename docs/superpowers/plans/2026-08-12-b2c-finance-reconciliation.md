...
- [ ] **Step 4: Update generated contracts manually**
...
- Preview returns quality/reconciliation summaries without creating reportable payments.
...
### Task 4: Add safe reconciliation summary and Admin review UI
...
- [ ] **Step 3: Implement safe summary and review page**

Return no provider payload, contact details, or raw source rows to the Viewer route. Show source state, staged counts, duplicate/conflict/unmatched counts, and publication gate. Admin decisions are always server submitted/audited. The page never calculates a final B2C total or claims a verified period.
...
- [ ] **Step 1: Update documentation and plan checkboxes**
