...
describe("Tap statement upload boundary", () => {
  beforeEach(() => { vi.resetAllMocks(); parseTapCsvMock.mockReturnValue(parsedStatement); linkB2cProviderEvidenceMock.mockResolvedValue({ exactMatches: [], mismatches: [], unmatchedEvidence: [] }); });
  ...
  it("reconciles exact Tap provider-ID evidence after a successful import", async () => {
    ...
    expect(linkB2cProviderEvidenceMock).toHaveBeenCalledWith(client, { importId: "22222222-2222-4222-8222-222222222222", provider: "tap" });
  });
