...
export interface ReviewItem { id: string; title: string; type: ReviewFlag; record: string; assignee: string; createdAt: string; priority: "High" | "Medium" | "Low"; status: "Open" | "Resolved"; reason: string; related: string[]; suggestedAction: string; }
