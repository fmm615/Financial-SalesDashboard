...
export function StripeSyncControl() {
  ...
  return <div className="border border-line bg-stone p-6">
    ...
    <p className="mt-2 max-w-2xl text-sm text-slate-600">Reads Stripe charges and refunds from the last 48 hours. PLAYBOOK never sends a write request to Stripe. Provider descriptions remain source evidence, and possible duplicates are retained for Admin review and excluded from reported totals.</p>
